...
namespace ECSAtmos.Systems
{
	...
	public class AtmosEndEntityCommandBufferSystem : EntityCommandBufferSystem
	{
        ...
        protected override unsafe void OnCreate()
        {
            ...
            this.RegisterSingleton<Singleton>(ref *m_PendingBuffers, World.Unmanaged, $"{nameof(AtmosEndEntityCommandBufferSystem)} {nameof(Singleton)}");
        }
	}
	...
	public class AtmosBeginningEntityCommandBufferSystem : EntityCommandBufferSystem
	{
        ...
        protected override unsafe void OnCreate()
        {
            ...
            this.RegisterSingleton<Singleton>(ref *m_PendingBuffers, World.Unmanaged, $"{nameof(AtmosBeginningEntityCommandBufferSystem)} {nameof(Singleton)}");
        }
	}
}